...
-- 3.Наполнить таблицу employee 70 строками.
...
-- 6.Наполнить таблицу salary 15 строками:
...
-- 10. В 10 строк из 40 вставить несуществующие employee_id
...
-- 13.Поменять тип столба role_name с int на varchar(30)
alter table roles 
alter column role_name type varchar(30);
-- 14.Наполнить таблицу roles 20 строками:
...
-- 16.Создать таблицу roles_employee
-- id. Serial  primary key,
...
-- 17. Наполнить таблицу roles_employee 40 строками:
